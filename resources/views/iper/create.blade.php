...
@section('content_header')
    <h1 class="p-2">Agregar Entrada al IPER</h1>
@stop

@section('content')
    <div class="p-2">
        <h2>Agregar Entrada</h2>
        <form action="{{ route('iper.store') }}" method="POST">
            @csrf
            <div class="mt-2">
            ...
            <div class="mt-2">
                ...
                <textarea class="form-control" name="sector" id="sector" cols="4" rows="4"></textarea>
            </div>
            <div class="mt-2">
                <label for="actividad" class="form-label">Actividad:</label>
                <textarea class="form-control" name="actividad" id="actividad" cols="4" rows="4"></textarea>
            </div>
            <div class="row mt-2">
                <div class="col-lg-6 col-sm-12">
                    <label class="form-label" for="peligro">Peligro:</label>
                    <input class="form-control" type="text" name="peligro" id="peligro">
                    @error('peligro')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input class="form-control" type="text" name="riesgo" id="riesgo">
                    @error('riesgo')
                        <div class="alert alert-danger mt-3"><small>*{{ $message }}</small></div>
                    @enderror
                </div>
            ...
            <div class="row mt-2">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input class="form-control" type="text" name="daño" id="daño">
                </div>
                <div class="col-lg-6 col-sm-12">
            ...
            <div class="mt-2">
                ...
                <textarea class="form-control" name="medidasControl" id="medidasControl" cols="30" rows="4"></textarea>
            </div>
            <div class="mt-2">
                <label for="jerarquiaControl" class="form-label">Jerarquia de control:</label>
                <textarea class="form-control" name="jerarquiaControl" id="jerarquiaControl" cols="30" rows="4"></textarea>
            </div>
            <div class="mt-2">
                <label for="responsables" class="form-label">Responsables:</label>
                <textarea class="form-control" name="responsables" id="responsables" cols="30" rows="4"></textarea>
            </div>
